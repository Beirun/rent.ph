...
<template>
  ...
  >
    ...
    <div class="p-4 flex flex-col gap-3">
      <div class="text-lg font-bold text-blue-600 dark:text-blue-400 truncate cursor-pointer hover:text-blue-700 dark:hover:text-blue-300 transition-colors" @click="goToProperty">
        {{ property.title }}
      </div>
      
      <div class="text-xl font-bold text-rose-600 dark:text-rose-400">
        ₱{{ formattedPrice }}
        <span class="text-xs font-normal text-gray-500 dark:text-gray-400 ml-1">{{ property.price_type || 'Monthly' }}</span>
      </div>

      <!-- Stats Badges -->
      <div class="flex items-center gap-2 flex-wrap">
        <div class="flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 dark:bg-emerald-900/10 rounded-md border border-emerald-100 dark:border-emerald-900/20">
        ...
        <div class="flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 dark:bg-amber-900/10 rounded-md border border-amber-100 dark:border-amber-900/20">
        ...
        <div class="flex items-center gap-1.5 px-2.5 py-1 bg-sky-50 dark:bg-sky-900/10 rounded-md border border-sky-100 dark:border-sky-900/20">
      ...
      <div class="flex items-center justify-between py-2">
        ...
        <label class="relative inline-flex items-center cursor-pointer">
          ...
          <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-200 dark:peer-focus:ring-blue-900/50 rounded-full peer dark:bg-zinc-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-0.5 after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-zinc-600 peer-checked:bg-blue-500 dark:peer-checked:bg-blue-600"></div>
        </label>
      </div>

      <!-- Action Buttons -->
      <div class="grid grid-cols-2 gap-2">
        <button class="flex items-center justify-center gap-1.5 py-2 px-3 cursor-pointer bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-md font-medium text-xs transition-colors shadow-sm">
          <Icon name="lucide:pencil" class="size-3.5 text-[#fafafa]" />
          Edit
        </button>
        <button class="flex items-center justify-center gap-1.5 py-2 px-3 cursor-pointer bg-amber-500 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-700 text-white rounded-md font-medium text-xs transition-colors shadow-sm">
      ...
      <div class="grid grid-cols-2 gap-2">
        <button class="flex items-center justify-center gap-1.5 py-2 px-3 cursor-pointer bg-rose-500 hover:bg-rose-600 dark:bg-rose-600 dark:hover:bg-rose-700 text-white rounded-md font-medium text-xs transition-colors shadow-sm">
          <Icon name="lucide:trash-2" class="size-3.5 text-[#fafafa]" />
          Delete
        </button>
        <button class="flex items-center justify-center gap-1.5 py-2 px-3 cursor-pointer bg-slate-600 hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-800 text-white rounded-md font-medium text-xs transition-colors shadow-sm">
      ...
      <!-- RAPA Upload Button -->
      <button class="flex items-center justify-center gap-2 py-2 px-3 cursor-pointer bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 hover:border-blue-400 dark:hover:border-blue-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium text-xs transition-colors">
