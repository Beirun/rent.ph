    ...
    <div class="p-6 max-w-8xl mx-auto min-h-screen bg-gray-50/50 dark:bg-[#0a0a0a]">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8 space-y-8">
          ...
          <section class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
            <h2 class="text-base font-bold text-gray-800 dark:text-white mb-6 uppercase tracking-tight">Property Category</h2>
            <div class="relative">
          ...
          <section class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
            <h2 class="text-base font-bold text-gray-800 dark:text-white mb-6 uppercase tracking-tight">Property Content</h2>
            <div class="space-y-6">
              <div class="space-y-2">
                <label class="text-xs font-bold text-gray-500 dark:text-zinc-400 mb-1 block px-1 uppercase tracking-wide">Title *</label>
              ...
              <div class="space-y-2">
                <label class="text-xs font-bold text-gray-500 dark:text-zinc-400 mb-1 block px-1 uppercase tracking-wide">Content *</label>
                <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900">
          ...
          <section class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
            <div class="flex items-center justify-between mb-6">
              ...
              <span class="text-xs font-medium text-gray-500 bg-gray-100 dark:bg-zinc-800 px-2 py-1 rounded-md">{{ galleryImages.length }} / 18 Images</span>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              <button @click="triggerUpload" type="button"
                ...
                <span class="mt-2 text-[10px] font-bold uppercase tracking-wider text-gray-400 group-hover:text-[#FE8E0A]">Add Photos</span>
              </button>
              ...
              <div v-for="img in galleryImages" :key="img.id"
                ...
                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-2">
                  <div class="flex justify-end">
                    <button @click="removeImage(img.id)" class="bg-red-500/80 hover:bg-red-500 backdrop-blur-md text-white p-1.5 rounded-lg transition-colors">
          ...
          <section class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-sm">
            <div class="p-6 space-y-6 border-b border-gray-100 dark:border-zinc-800">
              <h2 class="text-base font-bold text-gray-800 dark:text-white uppercase tracking-tight flex items-center gap-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                  <label class="text-xs font-bold text-gray-500 dark:text-zinc-400 px-1 uppercase tracking-wide">City / Municipality *</label>
                  <input v-model="formData.location.city" type="text" placeholder="e.g. Cebu City"
                    class="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-gray-800 dark:text-zinc-200 outline-none focus:ring-2 focus:ring-[#FE8E0A]/20 focus:border-[#FE8E0A] transition-all" />
                </div>
                <div class="space-y-2">
                  <label class="text-xs font-bold text-gray-500 dark:text-zinc-400 px-1 uppercase tracking-wide">Complete Address *</label>
            ...
            <div class="h-80 w-full relative bg-gray-100 dark:bg-zinc-950">
              <ClientOnly>
                <Map :center="[formData.location.longitude, formData.location.latitude]" :zoom="formData.location.zoom" class="h-full w-full" />
              </ClientOnly>
            </div>
            ...
            <div class="p-6 bg-white dark:bg-zinc-900 grid grid-cols-3 gap-6">
              <div class="space-y-1">
                ...
                <input v-model="formData.location.latitude" type="text" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-lg text-xs font-mono outline-none focus:border-[#FE8E0A]" />
              </div>
              <div class="space-y-1">
                <label class="text-[10px] text-gray-400 uppercase font-extrabold tracking-tighter">Longitude</label>
                <input v-model="formData.location.longitude" type="text" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-lg text-xs font-mono outline-none focus:border-[#FE8E0A]" />
              </div>
              <div class="space-y-1">
                <label class="text-[10px] text-gray-400 uppercase font-extrabold tracking-tighter">Zoom</label>
                <input v-model="formData.location.zoom" type="number" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-lg text-xs font-mono outline-none focus:border-[#FE8E0A]" />
              </div>
            </div>
          </section>

          <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
            <button @click="handleSave" class="w-full bg-[#ff5a5f] hover:bg-[#ff4449] text-white py-4 rounded-2xl font-bold transition-all shadow-lg shadow-red-500/20 active:scale-[0.98]">
        ...
        <div class="lg:col-span-4 space-y-6">
          <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
            <h2 class="text-sm font-bold text-gray-800 dark:text-white mb-6 uppercase tracking-tight flex items-center gap-2">
              <Icon name="lucide:sparkles" class="size-4 text-blue-500" /> Amenities
            </h2>
            <div class="max-h-80 overflow-y-auto space-y-1 pr-2 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-zinc-800">
              <div
                ...
                <label class="text-sm text-gray-600 dark:text-gray-400 cursor-pointer group-hover:text-gray-900 dark:group-hover:text-white">jhvjvh</label>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
            ...
            <div class="space-y-4">
              <div class="grid grid-cols-2 gap-3">
                <input v-model="formData.lessor.firstName" placeholder="First Name" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm outline-none focus:border-[#FE8E0A]" />
                <input v-model="formData.lessor.lastName" placeholder="Last Name" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm outline-none focus:border-[#FE8E0A]" />
              </div>
              <input v-model="formData.lessor.phone" placeholder="Phone Number" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm outline-none focus:border-[#FE8E0A]" />
              <input v-model="formData.lessor.email" placeholder="Email Address" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm outline-none focus:border-[#FE8E0A]" />
              <div class="relative">
                <select v-model="formData.lessor.country" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm outline-none appearance-none cursor-pointer">
